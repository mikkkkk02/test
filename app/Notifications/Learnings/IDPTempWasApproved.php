...
class IDPTempWasApproved extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'classes' => 'fa-book bg-green',
            'text' => 'Your changes to IDP No.' . $this->idp->id . ' has been approved by ' . $this->approver->renderFullname(),
            'body' => '',
