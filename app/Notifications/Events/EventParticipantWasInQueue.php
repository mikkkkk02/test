...
class EventParticipantWasInQueue extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'text' => $this->isUser ? 
                        'You have been added to the queue for the event ' . $this->event->title:
                        $this->user->renderFullname() . ' has been added to the queue for the event ' . $this->event->title,
            'body' => $this->isUser ? 
                        '' :
                        '',                        
