<template>
	<div>
				...
				<div class="col-sm-12">
					<div class="form-group">
						<div class="input-group">
							<button type="button" class="btn btn-default" id="daterangecompleted">
		...
		<table class="table table-responsive table-striped table-bordered completedData" style="width:100%">	
			<thead>
				<tr>
	              <th><b>Ticket#</b></th>
	              <th><b>Request#</b></th>
	...
	export default {
        ...
        methods: {
            ...
            read() {
            	...
            	var table = $('table.completedData').DataTable({
			  ...
			  //       stateLoadParams: function( settings, data ) {
            	...
            	$('#daterangecompleted').daterangepicker({
            		locale: {
						format: 'YYYY-MM-DD'
				    },
					opens: 'right',
            		...
            		$('#daterangecompleted span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
			    ...
			    function filterColumn ( i, selected ) {
				    $('.completedData').DataTable().column( i ).search(
