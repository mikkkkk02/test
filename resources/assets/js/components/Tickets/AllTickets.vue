<template>
	<div>
		...
		<table class="table table-responsive table-striped table-bordered allData" style="width:100%">	
			<thead>
				<tr>
	              <th><b>Ticket#</b></th>
	              <th><b>Request#</b></th>
	...
	export default {
        ...
        methods: {
            ...
            read() {
            	...
            	var table = $('table.allData').DataTable({
			  ...
			  //       stateLoadParams: function( settings, data ) {
			    ...
			    function filterColumn ( i, selected ) {
				    $('.allData').DataTable().column( i ).search(
