<template>
	<div>
				...
				<div class="col-sm-12">
					<div class="form-group">
						<div class="input-group">
							<button type="button" class="btn btn-default" id="daterangeongoing">
		...
		<table class="table table-responsive table-striped table-bordered ongoingData" style="width:100%">	
			<thead>
				<tr>
	              <th><b>Ticket#</b></th>
	              <th><b>Request#</b></th>
	...
	export default {
        ...
        methods: {
            ...
            read() {
            	...
            	var table = $('table.ongoingData').DataTable({
			  ...
			  //       stateLoadParams: function( settings, data ) {
            	...
            	$('#daterangeongoing').daterangepicker({
            		locale: {
						format: 'YYYY-MM-DD'
				    },
					opens: 'right',
            		...
            		$('#daterangeongoing span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
			    ...
			    function filterColumn ( i, selected ) {
				    $('.ongoingData').DataTable().column( i ).search(
