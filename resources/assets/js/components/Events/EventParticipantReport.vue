								...
								<tbody>
									...
									<template v-for="(list, index) in lists">
										...
										<tr>
											...
											<td>{{ list.participant.extra.fullname }}</td>
											<td>
												
												<template v-if="list.participant.department && list.participant.department.department && list.participant.department.department.division && list.participant.department.department.division.company">

													<a :href="list.participant.department.department.division.company.extra.view"
													>{{ list.participant.department.department.division.company.abbreviation }}</a>
											...
											<td>
												...
												<template v-if="list.participant.department && list.participant.department.department && list.participant.department.department.division">

													<a :href="list.participant.department.department.division.extra.view"
													>{{ list.participant.department.department.division.name }}</a>
											...
											<td>
												...
												<template v-if="list.participant.department && list.participant.department.department">

													<a :href="list.participant.department.department.extra.view"
													>{{ list.participant.department.department.name }}</a>
											...
											<td>{{ moment(list.approved_at, 'MMM. DD, YYYY (hh:mm a)') }}</td>
											<td>
												<center>
